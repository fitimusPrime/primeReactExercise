...
import { deleteAttachment } from 'reducers/dashboard/Actions'
    ...
    render() {
        ...
        return (
            <div>
                ...
                >
                    <DialogTitle className={ classes.colors}>Delete Attachment?</DialogTitle>
                    <DialogContent>
                        <DialogContentText  className={ classes.colors}>
                            Are you sure you want to delete it, once you delete all the children and content inside it will be deleted as well.
            </DialogContentText>
                    </DialogContent>
                    <DialogActions>
